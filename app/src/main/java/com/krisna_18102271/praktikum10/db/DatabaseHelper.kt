package com.krisna_18102271.praktikum10.db

import android.content.Context
import android.database.sqlite.SQLiteDatabase
import android.database.sqlite.SQLiteOpenHelper
import com.krisna_18102271.praktikum10.db.DatabaseContract.QuoteColumns.Companion.TABLE_QUOTE
...
internal class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME,
    ...
    companion object {
        ...
        " ${DatabaseContract.QuoteColumns.CATATAN} TEXT NOT NULL," +
        " ${DatabaseContract.QuoteColumns.PESAN} TEXT NOT NULL)"
    }
