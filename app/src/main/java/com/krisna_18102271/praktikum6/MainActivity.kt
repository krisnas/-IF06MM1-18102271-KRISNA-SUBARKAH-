package com.krisna_18102271.praktikum6
...
import com.krisna_18102271.praktikum6.adapter.CardViewMyDataAdapter
import com.krisna_18102271.praktikum6.adapter.GridMyDataAdapter
import com.krisna_18102271.praktikum6.adapter.ListMyDataAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showRecyclerList() {
        ...
        val listMyDataAdapter =
            ListMyDataAdapter(list)
    ...
    private fun showRecyclerGrid() {
        ...
        val gridMyDataAdapter =
            GridMyDataAdapter(list)
        rv_mydata.adapter = gridMyDataAdapter
    }
    private fun showRecyclerCardView() {
        rv_mydata.layoutManager = LinearLayoutManager(this)
        val cardViewMyDataAdapter =
            CardViewMyDataAdapter (list,this@MainActivity)
